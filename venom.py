...
TOKEN = '7191400201:AAFdekSQYC-FSQBedqllrx6lMA0S8nwsvb8'
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*FUCKING START 🩸\n\nHost: {target_ip}\nPort: {target_port}\nTime: {duration}*", parse_mode='Markdown')
    except Exception as e:
...
def handle_message(message):
    if message.text == "Instant Plan 🩸":
        ...
        bot.reply_to(message, "*Contact admin @L_X_OP*", parse_mode='Markdown')
    else:
